...
#  resources :operator_allot_details
 # resources :operator_allocation_transactions
 # resources :operation_managements
 # resources :process_plans
 # resources :part_configurations
 # resources :macro_signals
 ...
 #resources :error_masters
   namespace :api, defaults: {format: 'json'} do
      namespace :v1 do
        ...
        put "reset_password/:id" => "users#reset_password"        
	get "alarm_count" => "alarm_histories#alarm_count"
	get "oee_reports" => "machines#oee_reports"
        ...
        post 'post_hmi_reason' => 'hmi_reasons#post_hmi_reason'
	...
	get "sessions/forgot_pwd" => "sessions#forgot_pwd"
        post 'sessions/api'
        post 'sessions/alarm'
	...
	get "check_status" => "users#check_status"
     ...
     #   get 'rsmachine_data' => 'machines#rsmachine_data'
        ...
        get 'hour_wise_report_data' => 'machines#hour_wise_report_data'
...
#============================================ Added routes for code compare by UMA=================================
	...
	post 'file_upload' => 'program_confs#file_upload'
        get 'file_list' => 'program_confs#file_list'
#############
	get 'show_shift' => 'shifttransactions#show_shift'
	get 'get_operation_management' => 'operation_managements#get_operation_management'
############

        get 'idle_report' => 'machines#idle_report'
        get 'idle_report_chart' => 'machines#idle_report_chart'
        get 'idle_report_pareto' => 'machines#idle_report_pareto'
