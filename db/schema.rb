...
ActiveRecord::Schema.define(version: 20210510050205) do
  ...
  create_table "cnc_reports", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "time_diff"
    t.integer  "utilization"
    t.json     "all_cycle_time"
    t.json     "cycle_start_to_start"
    t.boolean  "is_sent"
    t.integer  "shift_id"
    t.integer  "operator_id"
    t.integer  "machine_id"
  ...
  create_table "hmi_machine_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["date"], name: "index_hmi_machine_details_on_date", using: :btree
    ...
    t.index ["shift_no"], name: "index_hmi_machine_details_on_shift_no", using: :btree
  ...
  create_table "macro_signal_openeds", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["machine_id"], name: "index_macro_signal_openeds_on_machine_id", using: :btree
  end

  create_table "macro_signals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.datetime "update_date"
    t.datetime "end_date"
    t.integer  "time_stamp"
    t.string   "signal"
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["machine_id"], name: "index_macro_signals_on_machine_id", using: :btree
  end
  ...
  create_table "operation_managements", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "operation_name"
    ...
    t.datetime "deleted_at"
    t.integer  "part_configuration_id"
    t.integer  "process_plan_id"
    t.integer  "tenant_id"
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["part_configuration_id"], name: "index_operation_managements_on_part_configuration_id", using: :btree
    t.index ["process_plan_id"], name: "index_operation_managements_on_process_plan_id", using: :btree
    t.index ["tenant_id"], name: "index_operation_managements_on_tenant_id", using: :btree
  end
  ...
  create_table "operator_allot_details", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "operation_management_id"
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["operation_management_id"], name: "index_operator_allot_details_on_operation_management_id", using: :btree
    t.index ["operator_allocation_id"], name: "index_operator_allot_details_on_operator_allocation_id", using: :btree
    t.index ["operator_id"], name: "index_operator_allot_details_on_operator_id", using: :btree
  end
  ...
  create_table "part_configurations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["tenant_id"], name: "index_part_configurations_on_tenant_id", using: :btree
  end
  ...
  create_table "process_plans", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.index ["part_configuration_id"], name: "index_process_plans_on_part_configuration_id", using: :btree
    t.index ["tenant_id"], name: "index_process_plans_on_tenant_id", using: :btree
  end
  ...
  add_foreign_key "macro_signal_openeds", "machines"
  add_foreign_key "macro_signals", "machines"
  ...
  add_foreign_key "operation_managements", "part_configurations"
  add_foreign_key "operation_managements", "process_plans"
  add_foreign_key "operation_managements", "tenants"
  ...
  add_foreign_key "operator_allot_details", "operation_managements"
  add_foreign_key "operator_allot_details", "operator_allocations"
  add_foreign_key "operator_allot_details", "operators"
  ...
  add_foreign_key "part_configurations", "tenants"
  ...
  add_foreign_key "process_plans", "part_configurations"
  add_foreign_key "process_plans", "tenants"
